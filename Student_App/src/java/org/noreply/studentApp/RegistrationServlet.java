...
public class RegistrationServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (rs) {
                request.setAttribute("result", "Thank you for registering!!!!!Please check your email.");
            } else {
                request.setAttribute("result", "Please enter valid detail and try again..");
            }
    ...
    private boolean sendEmail(String to) {
        ...
        final String user = "ajaythakkar2013@gmail.com";//change accordingly
        final String password = "AJAY@2013";//change accordingly
